...
# Load the dataset
data = pd.read_csv('Impersonation_for_gen.csv')
...
epochs = 10000
batch_size = 64
generator_model_path = 'generator_Impersonation_model.h5'
discriminator_model_path = 'discriminator_Impersonation_model.h5'
...
synthetic_df.to_csv('synthetic_Impersonation_dataframe_generated.csv', index=False)
print(f"\nGenerated synthetic data saved to synthetic_Impersonation_dataframe_generated.csv")

# Print a sample of the generated synthetic data
print("\nGenerated Synthetic Impersonation Attack CAN Messages (Sample):")
