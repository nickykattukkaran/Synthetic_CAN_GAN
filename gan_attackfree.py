...
# Load the dataset
data = pd.read_csv('Attackfree_for_gen.csv')
...
epochs = 3000
batch_size = 100
generator_model_path = 'generator_Attackfree_model.h5'
discriminator_model_path = 'discriminator_Attackfree_model.h5'
...
synthetic_df.to_csv('synthetic_Attackfree_dataframe_generated_6000.csv', index=False)
print(f"\nGenerated synthetic data saved to synthetic_Attackfree_dataframe_generated.csv")

# Print a sample of the generated synthetic data
print("\nGenerated Synthetic Attack free CAN Messages (Sample):")
